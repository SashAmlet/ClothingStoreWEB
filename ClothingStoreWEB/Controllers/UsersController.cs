...
namespace ClothingStoreWEB.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FName,LName,Email,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FName,LName,Email,Password")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
